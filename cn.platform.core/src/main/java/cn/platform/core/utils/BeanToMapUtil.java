...
import cn.platform.core.model.Demo;
...
//        Demo demo = new Demo("1","tony","北京");
//        Map map = BeanToMapUtil.convertBean(demo);
//        System.out.println(map);
        ...
        map.put("name","tim");
        map.put("address","杭州");
        Demo d = (Demo)BeanToMapUtil.convertMap(Demo.class, map);
